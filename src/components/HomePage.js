...
import { Instances, Instance, Environment, ContactShadows, Text } from '@react-three/drei'
...
export default function HomePage() {
  return (
    <Canvas style={{
        ...
        width: '100vw',
        height: '100vh',
     }} className="canvas" shadows dpr={[1, 2]} gl={{ antialias: false }} camera={{ fov: 75, position: [0, 0, 60], near: 10, far: 150 }}>
